...
const appName = "ta_for_insightidr";
const appNamespace = {
    owner: "nobody",
    app: appName,
    sharing: "app",
};
const pwRealm = "ta_for_insightidr_realm";
// let pwName = "password";
...
require([
    ...
    async function completeSetup() {
        ...
        const usernameToSave = $('#username_input').val();
        const passwordToSave = $('#password_input').val();
        const pwName = encodeURIComponent(usernameToSave);
